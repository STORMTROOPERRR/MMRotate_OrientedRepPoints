...
data = dict(
    ...
    train=dict(
        type='DOTADataset',
        ann_file='data/DOTA_1024/train/annfiles/',
        img_prefix='data/DOTA_1024/train/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
    ...
    val=dict(
        type='DOTADataset',
        ann_file='data/DOTA_1024/val/annfiles/',
        img_prefix='data/DOTA_1024/val/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=2000))
work_dir = './work_dirs\oriented_reppoints_50e_25p'
auto_resume = False
gpu_ids = range(0, 1)
