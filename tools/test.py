...
def parse_args():
    ...
    parser.add_argument('--eval', type=str, nargs='+', help='evaluation metrics, which depends on the dataset,'
    ...
    parser.add_argument('--gpu-ids', type=int, nargs='+', help='ids of gpus to use only applicable to non-distributed testing)')
    parser.add_argument('--format-only', action='store_true', help='Format the output results without perform evaluation. '
                                                                   'It is useful when you want to format the result to a specific format and submit it to the test server')
